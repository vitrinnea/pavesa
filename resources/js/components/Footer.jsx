            ...
            <div className="container mx-auto text-white px-4">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                    <div className="text-center md:text-left">
                        ...
                        <p className="font-milligramregular text-white leading-relaxed">
                    ...
                    <div className="text-center">
                        ...
                        <ul className="space-y-1 text-white">
                            {menus && menus.map((menuItem) => (
                                <li key={menuItem.id}>
                                    <a href={menuItem.url} target={menuItem.target} className="footer-link">
                                        {menuItem.title}
                                    </a>
                                </li>
                            ))}
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <a href="tel:{settings.contact_phone}" className="block mb-2 font-sans">
                            {settings.contact_phone}
                        </a>
                        <div className="flex justify-center items-end md:justify-start gap-3 mt-4 flex-wrap">
                            <a
                                href={settings.linkedin_url}
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <img src="/images/home/linkedin.png" alt="Linkedin Pavesa" />
                            </a>
                            <a
                                ...
                                rel="noopener noreferrer"
                            >
                                <img src="/images/home/facebook.png" alt="Linkedin Pavesa" />
                            </a>
                            <a
                                ...
                                rel="noopener noreferrer"
                            >
                                <img src="/images/home/instagram.png" alt="Linkedin Pavesa" />
                            </a>
                            <a
                                ...
                                rel="noopener noreferrer"
                            >
                                <img src="/images/home/youtube.png" alt="Linkedin Pavesa" />
                            </a>
                        </div>
                    </div>
                    <div className="text-center md:text-left">
                        ...
                        <a href="/contactenos" className="bg-[#2C9C47] max-w-[230px] py-4 px-6 rounded-full flex items-center justify-center mx-auto md:mx-0 text-white transition-all hover:scale-105 hover:bg-[rgba(44,156,71,0.9)] w-full sm:w-auto">
