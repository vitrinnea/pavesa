    ...
    return (
        <div>
            ...
            <section className="container-custom">
                <div className="relative">
                    ...
                    <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                        <div className="px-20">
                            <h2 className="text-white font-integralcfheavy text-2xl sm:text-7xl text-shadow max-w-xl mb-3">
                                CONTACTO
                            </h2>
                        </div>
                    </div>
            ...
            <section className="bg-[url(/images/contacto/bg-cotiza.png)] bg-[length:100%_100%] bg-no-repeat py-10">
                <h2 className="text-[#2C9C47] text-2xl sm:text-6xl font-integralcfheavy text-center">Cotiza tu <br/>proyecto</h2>
            </section>
            <section className="bg-[url(/images/contacto/bg-contact-2.png)] bg-[length:50%_100%] bg-no-repeat sm:mt-10">
            ...
            <div className="w-full">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4639.022272083673!2d-89.2794715!3d13.6705895!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8f632fb9d7b49fe7%3A0x97c558524e63da76!2sPavesa%2C%20S.A.%20de%20C.V.!5e1!3m2!1ses-419!2ssv!4v1757608169445!5m2!1ses-419!2ssv"
