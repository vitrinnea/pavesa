            ...
            <section className="container-custom">
                <div className="relative">
                    <img
                        ...
                        alt=""
                    />
                    <div className="absolute top-1/2 transform -translate-y-1/2 left-0 pt-10">
                        <div className="px-20">
                            <h2 className="text-white font-integralcfheavy lg:text-7xl text-shadow max-w-xl mb-3">
            ...
            <section className="max-w-7xl mx-auto px-4 py-12">
                <div className="grid grid-cols-12 gap-8">
                    <div className="col-span-12 md:col-span-8">
                        <h1 className="text-3xl sm:text-4xl font-bold mb-4 font-integralcfheavy text-[#11312C]">
                            {article.title}
                        </h1>
