    ...
    return (
        <div>
            ...
            <section className="bg-[url(/images/home/background-linea.png)] lg:bg-[length:100%_70%] bg-cover bg-top bg-no-repeat">
                    ...
                    <div className="flex flex-wrap w-full h-auto sm:h-[400px] md:h-[475px] lg:h-[528px]">
                        ...
                        >
                            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-[#2C9C47] text-white p-2 sm:p-3 text-sm sm:text-base opacity-0 group-hover:opacity-100 transition duration-300 font-milligrambold text-center">
                                Suministro y bombeo de concreto premezclado en El Salvador
                            </div>
                        </div>
                        <div
                ...
                <div className="w-full lg:container lg:mx-auto pt-20">
                    <div className="flex flex-col md:flex-row gap-4 items-center justify-center">
                        <div className="md:w-1/2 px-5">
                            <img src="/images/home/arquitectos-pavesa-1.png" alt="Arquitectos Pavesa" className="max-w-[450px] w-full h-auto " />
                        </div>
                ...
                <div className="container mx-auto pt-40">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 px-2">
                        <div className="col-span-1 h-[437px] bg-[url(/images/home/asfalto.png)] bg-cover relative group overflow-hidden">
                            <div className="absolute top-[-65px] left-0 w-full h-12 bg-white z-10 transform skew-y-6 origin-top-left"></div>
                        ...
                        <div className="col-span-1 h-[437px] bg-[url(/images/home/concreto.png)] bg-cover relative group overflow-hidden">
                            <div className="absolute top-[-50px] right-0 w-full h-16 bg-white z-10 transform skew-y-6 origin-top-left"></div>
                            <div className="absolute bottom-0 left-0 w-full pb-8 text-center">
                        ...
                        <div className="col-span-1 h-[437px] bg-[url(/images/home/terraceria.png)] bg-cover relative group overflow-hidden">
                            <div className="absolute top-[-20px] right-0 w-full h-16 bg-white z-10 transform -skew-y-6 origin-top-left"></div>
                            <div className="absolute bottom-0 left-0 w-full pb-8 text-center">
                        ...
                        <div className="col-span-1 h-[437px] bg-[url(/images/home/obra-gris.png)] bg-cover relative group overflow-hidden">
                            <div className="absolute top-[-50px] right-0 w-full h-16 bg-white z-10 transform skew-y-6 origin-top-left"></div>
                            <div className="absolute bottom-0 left-0 w-full pb-8 text-center">
                        ...
                        <div className="col-span-1 lg:px-5 px-4">
                            ...
                            <div className="grid grid-cols-2">
                                <div className="col-span-1 lg:px-6 md:px-4 px-2">
                                    ...
                                    <h5 className="font-milligrambold text-[#11312C] mt-5 mb-3 lg:text-2xl md:text-xl">Diseño <br/>personalizado</h5>
                                ...
                                <div className="col-span-1 lg:px-6 md:px-4 px-2 relative">
                                    ...
                                    <h5 className="font-milligrambold text-[#11312C] mt-5 mb-3 lg:text-2xl md:text-xl">Soluciones para todas las necesidades</h5>
                                    <p className="font-milligramregular text-[#11312C]">Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-span-1 lg:px-5 px-4">
                            <h2 className="lg:text-5xl md:text-4xl text-4xl text-[#11312C] font-integralcfheavy mb-5">Cumplimos certificaciones internacionales</h2>
            ...
            <section className="pb-32">
                <div className="container mx-auto">
                    <h2 className="text-center lgtext-5xl md:text-4xl sm:text-3xl text-[#11312C] font-integralcfheavy mb-8">Noticias y mas</h2>
