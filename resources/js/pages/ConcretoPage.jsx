                ...
                <div className="container-custom bg-[url(/images/concreto/bg-concreto.png)] bg-bottom bg-cover bg-no-repeat">
                    <div className="grid grid-cols-12 py-10 items-center">
                        ...
                        <div className="lg:col-span-5 md:col-span-6 col-span-12">
                            <img src={`/storage/${concretPage?.section_image_01}`} className="max-w-max ml-auto max-h-[650px]" alt="Concreto Pavesa - Experiencia y compromiso" />
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="container py-32 mx-auto">
                    <div className="relative">
                        <div className="absolute top-0 left-0 w-full">
                            <h2 className="lg:text-6xl md:text-5xl sm:text-4xl text-3xl font-integralcfheavy text-white px-28"
                                dangerouslySetInnerHTML={{ __html: concretPage?.section_title_03 }}
                            ></h2>
                        </div>
                        <img src={`/storage/${concretPage?.section_image_03}`} className="max-w-full mx-auto block" alt="Seccion 3 Concreto" />
                    </div>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-12 items-center">
                        <div className="md:col-span-7 col-span-12 relative">
                            ...
                            <div className="absolute bottom-0 right-0">
                                <h2 className="lg:text-5xl md:text-4xl text-3xl font-integralcfheavy text-[#2C9C47] lg:px-28 lg:pb-40 md:px-20 md:pb-20 px-28 pb-28"
                ...
                <div className="container mx-auto">
                    <div className="grid grid-cols-3 gap-10 py-10 px-10 bg-[#E9E9E9] rounded-[100px] z-40 relative">
                        <div className="col-span-3 mt-[-70px] text-center">
                            <h2 className="text-[#2C9C47] px-5 py-2 text-5xl font-integralcfheavy bg-[#E9E9E9] rounded-xl inline-block">{concretPage?.section_title_06}</h2>
                        </div>
